...
<body class="">
						...
						<div class="card mb-0">
							...
							<div class="card-body">
								...
								<div class="p-4">
									...
									<form class="row g-3 login-form needs-validation" action="<?= base_url('login') ?>" method="post" novalidate>
    ...
    <div class="col-12">
        ...
        <input type="text" name="mobile" value="<?= set_value('mobile'); ?>" class="form-control" id="mobile" placeholder="Enter your mobile number" required>
    ...
    <div class="col-12 text-center">
        <p class="mb-0">Don't have an account yet? <a href="<?= base_url('register'); ?>">Sign up here</a></p>
    </div>
