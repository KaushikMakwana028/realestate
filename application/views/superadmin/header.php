...
<head>
	...
	<style>
		...
		/* Keep utility dropdowns hidden until user clicks a toggle. */
		...
		/* Prevent sidebar flicker during initial JS/menu setup on page refresh. */
