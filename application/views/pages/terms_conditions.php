...
<head>
    ...
    <title>Terms and Conditions - Side Desk</title>
    ...
    <style>
        ...
        * {
        ...
        /* Reading progress side indicator */
        .content::before {
            content: '';
            position: absolute;
            left: 0;
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-inner">
            ...
            <h1><span class="emoji-icon">📋</span> Terms and Conditions</h1>
    ...
    <div class="content-container hidden" id="contentContainer">
        ...
        <div class="summary-card">
            ...
            <p>
                <strong>Please read carefully.</strong> These Terms and Conditions govern your use of Side Desk
                services. By accessing or using our platform, you agree to be bound by these terms. If you disagree
    ...
    <!-- Footer -->
    <div class="footer">
        <p>© 2026 <span class="footer-brand">Side Desk</span>. All rights reserved.</p>
        ...
        <div class="footer-made-with">
            Made with <span class="heart">❤️</span> for transparency
        </div>
    </div>
    ...
    <script>
        ...
        const sectionIcons = [
            ...
            'contact_support', 'balance', 'info', 'verified_user',
            'policy', 'handshake', 'workspace_premium'
        ];
