							...
							<div class="card-body">
								...
								<div class="p-4">
									...
									<div class="mb-3 text-center">
										<img src="<?= base_url('assets/images/title_logo.png') ?>" alt="Title Logo" class="auth-logo" />
									</div>
									...
									<div class="form-body">
<form class="row g-3 login-form needs-validation" action="<?= base_url('login/sign_up') ?>" method="post" novalidate>

    <div class="col-12">
        <label for="fullName" class="form-label">Full Name</label>
        <input type="text" name="full_name" class="form-control" id="fullName"
               value="<?= set_value('full_name'); ?>" placeholder="Enter your full name" required>
        <small class="text-danger"><?= form_error('full_name'); ?></small>
    </div>

    <div class="col-12">
        <label for="businessName" class="form-label">Business Name</label>
        <input type="text" name="business_name" class="form-control" id="businessName"
               value="<?= set_value('business_name'); ?>" placeholder="Enter your business name" required>
        <small class="text-danger"><?= form_error('business_name'); ?></small>
    </div>

    <div class="col-12">
        <label for="mobile" class="form-label">Mobile</label>
        <input type="text" name="mobile" class="form-control" id="mobile"
               value="<?= set_value('mobile'); ?>" placeholder="Enter your mobile number" required>
    ...
    <div class="col-12">
        <div class="text-center">
            <p class="mb-0">Already have an account? <a href="<?= base_url('login'); ?>">Sign in here</a></p>
        </div>
    </div>
